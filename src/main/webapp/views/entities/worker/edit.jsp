                    ...
                    <div class="card-body">
                        <form action="${ pageContext.request.contextPath }/pension/edit" method="post">
                            <div class="form-outline mb-4">
                                <input type="number" name="idNum" id="numId" class="form-control" minlength="8" maxlength="8" autofocus required data-mdb-showcounter="true" disabled value="${ worker.idNum }">
                                <label for="numId" class="form-label">Número de DNI</label>
                                <div class="form-helper"></div>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="text" name="names" id="namesId" class="form-control" minlength="3" maxlength="40" required autocomplete="name" autocapitalize="words" data-mdb-showcounter="true" value="${ worker.names }">
                                <label for="namesId" class="form-label">Nombres</label>
                                <div class="form-helper"></div>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="text" name="surname" id="surnameId" class="form-control" minlength="3" maxlength="40" required autocomplete="family-name" autocapitalize="words" data-mdb-showcounter="true" value="${ worker.surname }">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gender" id="genderId" value="male" class="form-check-input" <c:if test="${ worker.gender == 'Male' }">checked</c:if> >
                                    <label for="genderId" class="form-check-label">Masculino</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gender" id="genderId2" value="female" class="form-check-input" <c:if test="${ worker.gender == 'Female' }">checked</c:if> >
                                    <label for="genderId2" class="form-check-label">Femenino</label>
                                </div>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="date" name="bDay" id="bDayId" class="form-control" required value="${ worker.birthday }">
                                <label for="bDayId" class="form-label">Fecha de nacimiento</label>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="tel" name="mobileNum" id="mobileNumId" class="form-control" minlength="9" maxlength="9" required autocomplete="tel" data-mdb-showcounter="true" value="${ worker.mobileNum }">
                                <label for="mobileNumId" class="form-label">Número de móvil</label>
                                <div class="form-helper"></div>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="text" name="address" id="addressId" class="form-control" minlength="10" maxlength="40" required data-mdb-showcounter="true" value="${ worker.address }">
                                <label for="addressId" class="form-label">Dirección</label>
                                <div class="form-helper"></div>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="date" name="entryDate" id="entryDateId" class="form-control" required value="${ worker.entryDate}">
                                <label for="entryDateId" class="form-label">Fecha de entrada</label>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="date" name="terminationDate" id="terminationDateId" class="form-control" required value="${ worker.terminationDate}">
                            ...
                            <div class="form-outline mb-4">
                                <select name="position" id="positionCode" required class="mdb-select md-form md-outline colorful-select dropdown-primary form-select">
                                    <option value="${ worker.positionCode }" selected>${ worker.positionName }</option>
                            ...
                            <div class="form-outline mb-4">
                                <input type="number" name="salary" id="salaryId" class="form-control" step="0.1" minlength="4" maxlength="4" required data-mdb-showcounter="true" value="${ worker.salary }">
                            ...
                            <div class="form-outline mb-4">
                                <select name="pension" id="pensionCode" required class="mdb-select md-form md-outline colorful-select dropdown-primary form-select">
                                    <option value="${ worker.pensionCode }" selected>${ worker.pensionName }</option>
                            ...
                            <div class="form-outline mb-4">
                                <input type="number" name="minorChildren" id="minorChildrenId" class="form-control" minlength="1" max="4" required data-mdb-showcounter="true" value="${ worker.minorChildren }">
