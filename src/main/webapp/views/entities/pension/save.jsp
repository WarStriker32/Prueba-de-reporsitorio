                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <form action="${ pageContext.request.contextPath }/pension/save" method="post">
                            ...
                            <div class="form-outline mb-4">
                                <input type="text" name="name" id="nameId" class="form-control" minlength="3" maxlength="3" required autofocus autocapitalize="characters" data-mdb-showcounter="true">
                                <label for="nameId" class="form-label">Pensión</label>
